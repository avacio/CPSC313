...
int main(int argc, char **argv) {
  ...
  long thistime, besttime = LONG_MAX, totaltime = 0;
  ...
  for (trial = 0; trial < ntrials; ++trial) {
    ...
    printf("Base implementation run %2d done, alive %d, took %12ld usec\n", trial, alive, thistime);
  ...
  for (trial = 0; trial < ntrials; ++trial) {
    ...
    printf("Optimized game of life run %2d done, alive %d, took %12ld usec\n", trial, alive, thistime);
